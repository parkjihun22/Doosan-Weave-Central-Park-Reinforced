...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 모멘텀`,
    text2: `강화대교·초지대교로 서울·김포 접근성<br/>
            계양–강화 고속도로(추진) 등 교통 개선 기대`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>강화가 기다린 미래 프리미엄</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 강화대교·초지대교, 계양–강화 고속도로(추진)로 서울·김포·인천까지 편리한 접근성<br />
                  - 강화터미널·풍물시장·하나로마트·의료기관 등 도심 생활 인프라 밀집<br />
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="두산위브센트럴파크강화브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>두산위브센트럴파크강화</div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="두산위브센트럴파크강화오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="두산위브센트럴파크강화mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              강화의 새로운 시작, 높은 미래가치<br/>
              브랜드 신뢰 두산위브
              <br />
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 두산위브센트럴파크강화에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="두산위브센트럴파크강화모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="두산위브센트럴파크강화브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="두산위브센트럴파크강화오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
