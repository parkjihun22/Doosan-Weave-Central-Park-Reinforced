...
const BusinessGuide2 = () => {
    ...
    return (
        <div className={styles.container}>
            <Helmet>
            <title>두산위브 센트럴파크 강화 - 분양일정</title>
            <meta
                name="description"
                content="두산위브 센트럴파크 강화 분양(청약) 일정을 한눈에 확인하세요. 특별공급·1·2순위 접수, 모델하우스 오픈, 당첨자 발표 및 정당계약 등 핵심 일정을 안내합니다."
            />
            <link rel="canonical" href="http://www.sinbiapt.co.kr/BusinessGuide/plan" />
            ...
            <h1 className={styles.screenReaderOnly}>두산위브 센트럴파크 강화 - 분양일정</h1>
            <p className={styles.screenReaderOnly}>
            두산위브 센트럴파크 강화의 분양(청약) 일정을 한곳에서 확인하세요.
            특별공급·1·2순위 접수부터 당첨자 발표, 정당계약까지 단계별 안내를 제공합니다.
            </p>

            <div className={styles.textBox}>
            <div>강화의 새로운 시작 위에</div>
            <div>두산위브 센트럴파크 강화, 분양일정을 확인하세요.</div>
            </div>
