  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link rel="canonical" href="https://sinbiapt.co.krFloorPlan/Emodel" />
        ...
        />
        <meta property="og:url" content="https://sinbiapt.co.krFloorPlan/Emodel" />
        <meta property="og:image" content="https://sinbiapt.co.krimg/og/emodel.jpg" />
        ...
        />
        <meta name="twitter:image" content="https://sinbiapt.co.krimg/og/emodel.jpg" />
        <meta name="twitter:url" content="https://sinbiapt.co.krFloorPlan/Emodel" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://sinbiapt.co.krFloorPlan/Emodel",
            "description":
              "두산위브 센트럴파크 강화 E-모델하우스를 온라인에서 편리하게 둘러보세요. VR 가상 투어와 전용 59·72·84㎡ 세대별 평면도를 확인할 수 있습니다.",
            "primaryImageOfPage": {
              "@type": "ImageObject",
              "contentUrl": "https://sinbiapt.co.krimg/og/emodel.jpg",
              "width": 1200,
              "height": 630
            },
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "E-모델하우스", "item": "https://sinbiapt.co.krFloorPlan/Emodel" }
              ]
            }
          })}
        </script>
