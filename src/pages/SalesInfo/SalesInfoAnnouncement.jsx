...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        ...
        <Helmet>
          <title>두산위브 센트럴파크 강화 - 모집공고 안내</title>
          <meta
            name="description"
            content="두산위브 센트럴파크 강화 모집공고를 한눈에 확인하세요. 공급 세대수·공급면적·분양가, 청약 일정·자격, 당첨자 발표·정당계약 및 유의사항을 안내합니다."
          />
          <link rel="canonical" href="http://www.sinbiapt.co.kr/SalesInfo/announcement" />
        ...
        <h1 className={styles.screenReaderOnly}>
          두산위브 센트럴파크 강화 - 모집공고 안내
        </h1>
        <p className={styles.screenReaderOnly}>
          본 페이지에서는 두산위브 센트럴파크 강화의 모집공고 주요 사항을 안내합니다.
        ...
        <div className={styles.textBox}>
          ...
          <div>두산위브 센트럴파크 강화</div>
        </div>

      {/* <img
        className={`${styles.image2} ${isImage2Loaded ? styles.showImage2 : ''}`}
        src={page1}
        alt="두산위브센트럴파크강화모집공고안내-image1"
