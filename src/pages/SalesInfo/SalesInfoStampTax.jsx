...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        ...
        <Helmet>
          <title>두산위브 센트럴파크 강화 - 인지세 납부 안내</title>
          <meta
            name="description"
            content="두산위브 센트럴파크 강화 분양(계약) 시 필요한 인지세 납부 기준과 절차, 금액 및 유의사항을 한눈에 확인하세요."
          />
          <link rel="canonical" href="http://www.sinbiapt.co.kr/SalesInfo/stampTax" />
      ...
      <p className={styles.screenReaderOnly}>
        두산위브센트럴파크강화의 인지세 안내 페이지는 분양과 관련된 세금
      ...
      <div className={styles.textBox}>
        ...
        <div>소수만 누리는 프리미엄 두산위브센트럴파크강화</div>
      </div>
